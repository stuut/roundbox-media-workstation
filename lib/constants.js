...
export const generalPerformanceQuestions = [
  "Which of these ads performed the best overall?",
  "Which ad had the best return on investment?",
  "Summarize which ad had the highest click-through rate and lowest cost per click."
]

export const  conversionBasedWwithTicketSales = [
