    ...
    if (textEditing){
      ...
      if (resizingSide) {
        ...
        if (!obj.clippingPath){
          ...
          const newLeft   = -newW / 2
          const newRight  =  newW / 2
          const newTop    = -newH / 2
          const newBottom =  newH / 2

          localCx = ((newLeft + newRight) / 2) - ((oldLeft + oldRight) / 2)
          localCy = ((newTop + newBottom) / 2) - ((oldTop + oldBottom) / 2)
        }
