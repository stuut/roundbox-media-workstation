  ...
  const handleMouseMove = (e) => {
    ...
    // dragging element
      ...
      if (resizing) {
        ...
        obj.clippingPath.width = clipWidth
        obj.clippingPath.height = clipHeight
        obj.clippingPath.dx = obj.cx
        obj.clippingPath.dy = obj.cy
      ...
      if (resizingSide) {
        ...
        const worldDy =
          ...
          if (!obj.clippingPath.dx || !obj.clippingPath.dy){
            obj.clippingPath.dx = obj.cx
            obj.clippingPath.dy = obj.cy
          }
          ...
          obj.clippingPath.width = clipWidth
          obj.clippingPath.height = clipHeight
          obj.clippingPath.dx += worldDx
          obj.clippingPath.dy += worldDy
